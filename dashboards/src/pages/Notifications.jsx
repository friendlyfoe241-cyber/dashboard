...
function NotificationsContent() {
  ...
  return (
    <div>
      {/* Discord Settings - ALWAYS VISIBLE */}
      <Card style={{ marginBottom: '1.5rem', border: '2px dashed #5865F2' }}>
        <h3 style={{ marginTop: 0, display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          <span style={{ fontSize: '0.7rem', color: 'var(--body-alt)', marginLeft: 'auto' }}>
            debug: {String(hasDiscord)}
          </span>
        </h3>
