...
const IconReply = () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 17 4 12 9 7"/><path d="M20 18v-2a4 4 0 0 0-4-4H4"/></svg>;
const IconEdit = () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>;
const IconDelete = () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>;
const IconForward = () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>;
...
const IconCheck = () => <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>;
const IconCheckDouble = () => <svg width="14" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="18 6 9 17 4 12"/><polyline points="22 6 13 17"/></svg>;
...
// Direct messages — enhanced with reactions, replies, edit, delete, forward, media
    ...
    <div className="dm-thread">
              ...
              {m.isDeleted ? (
                ...
                <>
                  ...
                  <div className="dm-bubble-actions">
                    <button onClick={() => setReplyingTo(m)} title="Reply">&lt;IconReply />↩️<lt;/button>
                    <button onClick={() => setShowReactionPicker(showReactionPicker === m.id ? null : m.id)} title="React">+/button>
                    {m.mine && <button onClick={() => startEdit(m)} title="Edit">&lt;IconEdit />✏️<lt;/button>}
                    {m.mine && <button onClick={() => handleDelete(m.id)} title="Delete">&lt;IconDelete />🗑️<lt;/button>}
                    <button onClick={() => setShowForwardModal(m)} title="Forward">&lt;IconForward />↗️<lt;/button>
                  </div>
      ...
      {replyingTo && (
        <div className="dm-reply-indicator">
          ...
          <button onClick={() => setReplyingTo(null)} className="dm-reply-close">&lt;IconClose />✕<lt;/button>
        </div>
      )}
