    ...
    <div className="dm-thread">
              ...
              {m.isDeleted ? (
                ...
                <>
                  ...
                  <div className="dm-bubble-actions">
                    ...
                    {m.mine && <button onClick={() => startEdit(m)} title="Edit">✏️</button>}
                    {m.mine && <button onClick={() => handleDelete(m.id)} title="Delete">🗑️</button>}
                    <button onClick={() => setShowForwardModal(m)} title="Forward">↗️</button>
                  </div>
      ...
      {replyingTo && (
        <div className="dm-reply-indicator">
          ...
          <button onClick={() => setReplyingTo(null)} className="dm-reply-close">✕</button>
        </div>
      )}
