...
export const researchers = [
  ...
  // Test Researcher account
  {
    ...
    password: 'scrypt:22ca35de9094ea8d493987b1eb5b02bf:43791b08018f386bbb7ebcb9bdae8cf8aa8bb1fde9ba971e0523fc70f7f16bb1',
    kind: 'researcher',
    tags: [RESEARCHER_TAGS.LEAD_RESEARCHER],
    email: 'testresearcher@synthica.org',
    discord: 'testresearcher',
    resumeUrl: '',
    gpa: '',
    researchExperience: 7,
